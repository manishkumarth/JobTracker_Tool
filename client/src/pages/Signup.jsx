  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 auth-gradient relative overflow-hidden items-center justify-center">
        {/* Decorative orbs */}
        <div className="absolute top-16 right-20 w-72 h-72 rounded-full bg-brand-400/20 blur-3xl" />
        <div className="absolute bottom-20 left-10 w-56 h-56 rounded-full bg-brand-300/25 blur-3xl" />
        <div className="absolute top-1/3 right-1/3 w-48 h-48 rounded-full bg-brand-500/10 blur-2xl" />
        ...
        <div className="relative z-10 text-center px-12 animate-fade-in">
          ...
          <h2 className="text-4xl font-extrabold text-brand-900 leading-tight mb-4">
            Start tracking
            <br />
            <span className="text-brand-600">your applications</span>
          </h2>
          <p className="text-brand-700/70 text-lg max-w-sm mx-auto">
            Join thousands of job seekers who land interviews faster with smart
            mail tracking.
          </p>
        </div>
      </div>
